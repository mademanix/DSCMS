	...
	<section id="main">
		<div class="container-fluid">
				...
				<div class="collapse navbar-collapse navbar-ex1-collapse">
			  		<div class="container">
			    		<ul class="nav navbar-nav">
		        			<li><a href="#main" class="page-scroll">[ Główna ]<span class="sr-only">(aktywna)</span></a></li>
		        			<li><a href="<?php echo base_url();?>ddp">[ DDP ]</a></li>
		        			<li><a href="<?php echo base_url();?>download">[ Download ]</a></li>
		      			</ul>
		      			<ul class="nav navbar-nav navbar-right">
		      				<li><a href="<?php echo base_url();?>panel">[ H4x10R ]</a></li>
			...
			<header class="text-center">
				<h1>MadStories - centrum BBP</h1>
				<h2>[ bardzo bagatelnych przemyśleń ]</h2>
				<a href="#content" class="btn btn-circle page-scroll hidden-sm-down page-scroll">
			...
			<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
			  <div class="modal-dialog" role="document">
			    <div class="modal-content">
			     	...
			     	<p class="hidden-lg" style="color: #FF9E9E">Cholernie mnie ciekawi, jak wywołałeś to okno. Znaczy, jeśli zmniejszyłeś teraz okno przeglądarki, jest ok, ale jeśli jesteś na telefonie, to opcje są dwie: Twoja przeglądarka jest <span style="text-decoration: line-through";>chujowa</span> zepsuta, albo jakimś cudem to wywołałeś. Jeśli jest to opcja druga, gratuluję - właśnie wygrałeś satysfakcję.</p>
			    </div>
			  </div>
			</div>
	</section>
