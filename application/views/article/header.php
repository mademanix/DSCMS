...
<html lang="">
	<head>
		...
		<link rel="stylesheet" href="<?php echo base_url();?>js/highlight/styles/monokai-sublime.css">
		<script src="<?php echo base_url();?>js/highlight/highlight.pack.js"></script>
		...
		<div class="container-fluid">
			<nav class="navbar navbar-default navbar-fixed-top">
				<div class="navbar-header">
					...
					<a class="navbar-brand hidden-sm hidden-md hidden-lg" href="<?php echo base_url();?>">MadStories</a>
				</div>
			  		...
			  		<div class="container">
			    		<ul class="nav navbar-nav">
		      			...
		      			<ul class="nav navbar-nav navbar-right">
		      				...
		      				<li><a href="https://www.facebook.com/mademan21"><i class="fa fa-facebook-official" aria-hidden="true"></i></a></li>
